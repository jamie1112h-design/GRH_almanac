...
const DATA = [
  ...
  },
  {
    ...
    body: {
      ...
      frictionPoints: "Still concept-stage – no MVP has been built and no supplier relationship for the freeze-dried product has been confirmed. The open question is whether the product is manufactured in-house, white-labeled, or dropped in favor of the book alone.",
  ...
  },
  {
    ...
    body: {
      ...
      frictionPoints: "Still concept-stage – the book exists as a structural outline rather than drafted chapters. Publishing under Grand River Hills Publishing is confirmed direction, but the DBA registration itself is not yet complete.",
  ...
  },
  {
    ...
    body: {
      ...
      frictionPoints: "This is manuscript-stage only – no production attachment, no coverage/notes pass complete, and no determination yet on whether this is pursued as a spec screenplay, a novelization, or both.",
  ...
  },
  {
    ...
    body: {
      ...
      frictionPoints: "The completed business case template returned a 'Needs More Research' recommendation – user-adoption uncertainty and hot-side heat dissipation remain unresolved engineering questions. The $800K seed / 1,250% five-year ROI pitch exists, but no prototype has been physically built or tested.",
  ...
  },
  {
    ...
    body: {
      ...
      frictionPoints: "Front-of-book pages (title page, copyright page, and the rest of the front matter) and the wraparound print cover still need to be built before KDP submission. No other blockers logged.",
  ...
  },
  {
    ...
    body: {
      ...
      frictionPoints: "Only five stories are confirmed drafted; total planned scope, editing status, and cover status are not yet logged.",
  ...
  },
  {
    ...
    body: {
      ...
      frictionPoints: "The manuscript itself is complete, but editing pass, cover art, and front-of-book status haven't been logged – how far along it is beyond the spread count isn't yet known.",
  ...
  },
  {
    ...
    body: {
      market: "Not yet assessed.",
      differentiation: "Not yet assessed.",
      frictionPoints: "Concept-stage only – no specification, prototype, or build has started.",
  ...
  },
  {
    ...
    body: {
      market: "Not yet assessed.",
      differentiation: "Not yet assessed.",
      frictionPoints: "Nothing built yet – this is a stated interest only, with no concept document, prototype, or spec to draw from.",
  ...
  },
  {
    ...
    body: {
      market: "Not yet assessed.",
      differentiation: "Not yet assessed.",
      frictionPoints: "Concept-stage only, and the name itself is marked provisional. No spec or build work exists yet.",
